...
-- DropForeignKey
ALTER TABLE "ChatUser" DROP CONSTRAINT "ChatUser_chatRoomId_fkey";
...
-- DropForeignKey
ALTER TABLE "ReportUser" DROP CONSTRAINT "ReportUser_reportedId_fkey";

-- DropForeignKey
ALTER TABLE "ReportUser" DROP CONSTRAINT "ReportUser_reporterId_fkey";
...
-- DropForeignKey
ALTER TABLE "UserLike" DROP CONSTRAINT "UserLike_fromUserId_fkey";

-- DropForeignKey
ALTER TABLE "UserLike" DROP CONSTRAINT "UserLike_toUserId_fkey";
...
-- AddForeignKey
ALTER TABLE "ChatUser" ADD CONSTRAINT "ChatUser_chatRoomId_fkey" FOREIGN KEY ("chatRoomId") REFERENCES "ChatRoom"("id") ON DELETE CASCADE ON UPDATE CASCADE;
